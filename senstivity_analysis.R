...
for (j in 1:iter) {
 ...
 # sigma2_ctl = c(sigma2_bl, 0.8, 1.1, 1.4, 1.23, 1.48)
  ...
  lm <- summary(lm(y_mar ~ as.factor(group) + y_bl, data = data_true))
  
  true_value[j] <- lm$coefficients[2, 1]
  
  # Genarate discontinue patterns
  # data_true$r <- if_else(data_true$first_offtrt_visit==5 & 
  ...
  bayesDraws <- draws(
    ...
    method = method_bayes(control=control_bayes(warmup=200,thin=1,chains = 1),
                          n_samples = 5000,
                          same_cov = TRUE
                          #seed = 484381136
    ))
...
res <- as.data.frame( cbind(j2r_constant_k0,cir_constant_k1,j2r_constant_k0_se,cir_constant_k1_se,
                            mmrm_mean,mmrm_se,cir_mean,cir_se,j2r_mean,j2r_se,true_value))
...
write.csv(res,"/home/lsh1901704/res_high")

write.csv(causal_k_mean0,"/home/lsh1901704/causal_k_mean0_high")
write.csv(causal_k_mean05,"/home/lsh1901704/causal_k_mean05_high")
write.csv(causal_k_mean1,"/home/lsh1901704/causal_k_mean1_high")

write.csv(causal_k_mean0_se,"/home/lsh1901704/causal_k_mean0_se_high")
write.csv(causal_k_mean05_se,"/home/lsh1901704/causal_k_mean05_se_high")
write.csv(causal_k_mean1_se,"/home/lsh1901704/causal_k_mean1_se_high")
